...
public class Mechanic extends Staff implements PropertyChangeListener
{
    private int salaryEarned = 50;
    ...
    public void fixCar()
    {
        ...
        public int carsFixed = 0;

        if(carStat = 0 || carStat = 1)
        {
            System.out.println("Car Not Fixed");
        }
        else if(carStat = 2)
        {
