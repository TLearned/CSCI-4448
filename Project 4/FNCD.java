...
public class FNCD implements SysOut {
    ...
    public int FNCDid; //Tyler Learned
    FNCD() {
        staff = new ArrayList<>();
    ...
    void raceDay(Enums.DayOfWeek day){//Tyler Learned
        //race attendance
        //race results
    }
    ...
    void addStaff(Enums.StaffType t) {
        ...
        if (t == Enums.StaffType.Driver) newStaff = new Driver();   //Tyler Learned
    ...
    void addVehicle(Enums.VehicleType t) {
        ...
        if (t == Enums.VehicleType.Ecar) v = new Ecar(); //Tyler Learned
        if (t == Enums.VehicleType.Moto) v = new Moto(); //Tyler Learned
        if (t == Enums.VehicleType.Monster) v = new Monster(); //Tyler Learned
        if (t == Enums.VehicleType.ThreeWheeler) v = new Ecar(); //Tyler Learned
        if (t == Enums.VehicleType.SixWheeler) v = new Moto(); //Tyler Learned
        if (t == Enums.VehicleType.Trail) v = new Monster(); //Tyler Learned
